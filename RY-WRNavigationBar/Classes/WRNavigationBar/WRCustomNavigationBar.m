...
//    NSInteger buttonWidth = 44;
    ...
    // fix-roin
    margin = 16;
    CGFloat rightButtonWidth = CGRectGetWidth(self.rightButton.frame);
    CGFloat leftButtonWidth = CGRectGetWidth(self.leftButton.frame);
//    titleLabelWidth = CGRectGetWidth(self.titleLable.frame);

    self.backgroundView.frame = self.bounds;
    self.backgroundImageView.frame = self.bounds;
    self.leftButton.frame = CGRectMake(margin, top, leftButtonWidth, buttonHeight);
    self.rightButton.frame = CGRectMake(kWRScreenWidth - rightButtonWidth - margin, top, rightButtonWidth, buttonHeight);
...
// add-lry
- (void)wr_setButtonFond:(UIFont *)fond {
    self.leftButton.titleLabel.font = fond;
    self.rightButton.titleLabel.font = fond;
    [self.leftButton sizeToFit];
    [self.rightButton sizeToFit];
    [self updateFrame];
}
