...
- (BOOL)navigationBar:(UINavigationBar *)navigationBar shouldPopItem:(UINavigationItem *)item {
    ...
    // - roin 莫名bug
    NSInteger m = self.viewControllers.count - n;
    if (m < 0 || m > 10000) {
        m = 0;
    }
    UIViewController *popToVC = self.viewControllers[m];
    // - roin

//    UIViewController *popToVC = self.viewControllers[self.viewControllers.count - n]; // 原有
